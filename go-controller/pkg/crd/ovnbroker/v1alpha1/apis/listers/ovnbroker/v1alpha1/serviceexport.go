...
type ServiceExportLister interface {
	...
	List(selector labels.Selector) (ret []*ovnbrokerv1alpha1.ServiceExport, err error)
...
type serviceExportLister struct {
	listers.ResourceIndexer[*ovnbrokerv1alpha1.ServiceExport]
}
...
func NewServiceExportLister(indexer cache.Indexer) ServiceExportLister {
	return &serviceExportLister{listers.New[*ovnbrokerv1alpha1.ServiceExport](indexer, ovnbrokerv1alpha1.Resource("serviceexport"))}
}

// ServiceExports returns an object that can list and get ServiceExports.
func (s *serviceExportLister) ServiceExports(namespace string) ServiceExportNamespaceLister {
	return serviceExportNamespaceLister{listers.NewNamespaced[*ovnbrokerv1alpha1.ServiceExport](s.ResourceIndexer, namespace)}
}
...
type ServiceExportNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*ovnbrokerv1alpha1.ServiceExport, error)
