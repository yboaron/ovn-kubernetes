...
type ServiceImportLister interface {
	...
	List(selector labels.Selector) (ret []*ovnbrokerv1alpha1.ServiceImport, err error)
...
type serviceImportLister struct {
	listers.ResourceIndexer[*ovnbrokerv1alpha1.ServiceImport]
}
...
func NewServiceImportLister(indexer cache.Indexer) ServiceImportLister {
	return &serviceImportLister{listers.New[*ovnbrokerv1alpha1.ServiceImport](indexer, ovnbrokerv1alpha1.Resource("serviceimport"))}
}

// ServiceImports returns an object that can list and get ServiceImports.
func (s *serviceImportLister) ServiceImports(namespace string) ServiceImportNamespaceLister {
	return serviceImportNamespaceLister{listers.NewNamespaced[*ovnbrokerv1alpha1.ServiceImport](s.ResourceIndexer, namespace)}
}
...
type ServiceImportNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*ovnbrokerv1alpha1.ServiceImport, error)
