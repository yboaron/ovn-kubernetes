...
func (b *ClusterStatusApplyConfiguration) WithClusterID(value string) *ClusterStatusApplyConfiguration {
	b.ClusterID = &value
	return b
}

// WithEndpointCount sets the EndpointCount field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the EndpointCount field is set to the value of the last call.
func (b *ClusterStatusApplyConfiguration) WithEndpointCount(value int32) *ClusterStatusApplyConfiguration {
	b.EndpointCount = &value
	return b
}
