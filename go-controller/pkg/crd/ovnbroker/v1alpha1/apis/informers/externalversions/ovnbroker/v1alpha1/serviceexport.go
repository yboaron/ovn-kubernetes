...
type ServiceExportInformer interface {
	...
	Lister() ovnbrokerv1alpha1.ServiceExportLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BrokerV1alpha1().ServiceExports(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceExports(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceExports(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceExports(namespace).Watch(ctx, options)
			},
		},
		&crdovnbrokerv1alpha1.ServiceExport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceExportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdovnbrokerv1alpha1.ServiceExport{}, f.defaultInformer)
}

func (f *serviceExportInformer) Lister() ovnbrokerv1alpha1.ServiceExportLister {
	return ovnbrokerv1alpha1.NewServiceExportLister(f.Informer().GetIndexer())
}
