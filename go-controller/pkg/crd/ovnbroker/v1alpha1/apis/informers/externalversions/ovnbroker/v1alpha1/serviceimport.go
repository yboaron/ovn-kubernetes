...
type ServiceImportInformer interface {
	...
	Lister() ovnbrokerv1alpha1.ServiceImportLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BrokerV1alpha1().ServiceImports(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceImports(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceImports(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BrokerV1alpha1().ServiceImports(namespace).Watch(ctx, options)
			},
		},
		&crdovnbrokerv1alpha1.ServiceImport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceImportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdovnbrokerv1alpha1.ServiceImport{}, f.defaultInformer)
}

func (f *serviceImportInformer) Lister() ovnbrokerv1alpha1.ServiceImportLister {
	return ovnbrokerv1alpha1.NewServiceImportLister(f.Informer().GetIndexer())
}
